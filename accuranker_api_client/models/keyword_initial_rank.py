...
from ..models.keyword_initial_rank_landing_page import KeywordInitialRankLandingPage
from ..models.keyword_initial_rank_page_serp_features import KeywordInitialRankPageSerpFeatures
from ..models.keyword_initial_rank_search_intent_item import KeywordInitialRankSearchIntentItem
from ..models.keyword_initial_rank_title_description import KeywordInitialRankTitleDescription
from ..types import UNSET, Unset

T = TypeVar("T", bound="KeywordInitialRank")

@attr.s(auto_attribs=True)
class KeywordInitialRank:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        search_intent (Union[Unset, List[KeywordInitialRankSearchIntentItem]]):
        highest_ranking_page (Union[Unset, str]):
        landing_page (Union[Unset, KeywordInitialRankLandingPage]):
        title_description (Union[Unset, KeywordInitialRankTitleDescription]):
        ...
        page_serp_features (Union[Unset, KeywordInitialRankPageSerpFeatures]):
    """
    ...
    search_intent: Union[Unset, List[KeywordInitialRankSearchIntentItem]] = UNSET
    highest_ranking_page: Union[Unset, str] = UNSET
    landing_page: Union[Unset, KeywordInitialRankLandingPage] = UNSET
    title_description: Union[Unset, KeywordInitialRankTitleDescription] = UNSET
    ...
    page_serp_features: Union[Unset, KeywordInitialRankPageSerpFeatures] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for search_intent_item_data in (_search_intent or []):
            search_intent_item = KeywordInitialRankSearchIntentItem.from_dict(search_intent_item_data)
        ...
        if isinstance(_landing_page,  Unset):
            ...
            landing_page = KeywordInitialRankLandingPage.from_dict(_landing_page)
        ...
        if isinstance(_title_description,  Unset):
            ...
            title_description = KeywordInitialRankTitleDescription.from_dict(_title_description)
        ...
        if isinstance(_page_serp_features,  Unset):
            ...
            page_serp_features = KeywordInitialRankPageSerpFeatures.from_dict(_page_serp_features)




        keyword_initial_rank = cls(
            id=id,
        ...
        keyword_initial_rank.additional_properties = d
        return keyword_initial_rank
