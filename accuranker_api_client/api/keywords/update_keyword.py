...
from ...models.keyword_settings import KeywordSettings
...
def sync_detailed(
    *,
    ...
    """Start job for updating settings for keyword(s)

     Update settings for a keyword on a domain. Only keywords on domains authorized from the token
    provided can be updated. Curl example:
