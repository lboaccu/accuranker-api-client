...
T = TypeVar("T", bound="CompetitorHistoryRankingDistribution")

@attr.s(auto_attribs=True)
class CompetitorHistoryRankingDistribution:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        competitor_history_ranking_distribution = cls(
        ...
        competitor_history_ranking_distribution.additional_properties = d
        return competitor_history_ranking_distribution
