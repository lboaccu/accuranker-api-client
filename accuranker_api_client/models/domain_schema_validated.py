...
T = TypeVar("T", bound="DomainSchemaValidated")

@attr.s(auto_attribs=True)
class DomainSchemaValidated:
    """
    Attributes:
        domain (str): No http:// or www. You can enter a path that must be found. Eg. example.com/path. Search result
            must then begin with your path to match.
        default_searchsettings_names (List[SearchSettings]): List of search settings that will be default for keywords
            on this domain.
        group_id (int): Id of the group the domain should belong to.
        ...
        include_subdomains (Union[Unset, bool]): Include results from sub.domain.com. Default: True.
        google_business_name_list (Union[Unset, List[Any]]): For some local results Google does not include a link to
    ...
    domain: str
    default_searchsettings_names: List[SearchSettings]
    group_id: int
    display_name: Union[Unset, str] = UNSET
    include_subdomains: Union[Unset, bool] = True
    google_business_name_list: Union[Unset, List[Any]] = UNSET
    twitter_handle: Union[Unset, str] = UNSET
    exact_match: Union[Unset, bool] = False
    share_of_voice_percentage: Union[Unset, bool] = False
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        default_searchsettings_names = []
        _default_searchsettings_names = d.pop("default_searchsettings_names")
        for default_searchsettings_names_item_data in (_default_searchsettings_names):
        ...
        google_business_name_list = cast(List[Any], d.pop("google_business_name_list", UNSET))
        ...
        domain_schema_validated.additional_properties = d
        return domain_schema_validated
