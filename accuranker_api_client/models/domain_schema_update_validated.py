...
T = TypeVar("T", bound="DomainSchemaUpdateValidated")

@attr.s(auto_attribs=True)
class DomainSchemaUpdateValidated:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        domain_schema_update_validated = cls(
            domain=domain,
        ...
        domain_schema_update_validated.additional_properties = d
        return domain_schema_update_validated
