...
T = TypeVar("T", bound="KeywordInitialRankPageSerpFeatures")

@attr.s(auto_attribs=True)
class KeywordInitialRankPageSerpFeatures:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyword_initial_rank_page_serp_features = cls(
            id=id,
            total=total,
        ...
        keyword_initial_rank_page_serp_features.additional_properties = d
        return keyword_initial_rank_page_serp_features
