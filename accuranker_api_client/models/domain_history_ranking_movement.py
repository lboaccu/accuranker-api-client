...
T = TypeVar("T", bound="DomainHistoryRankingMovement")

@attr.s(auto_attribs=True)
class DomainHistoryRankingMovement:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        domain_history_ranking_movement = cls(
            winners=winners,
        ...
        domain_history_ranking_movement.additional_properties = d
        return domain_history_ranking_movement
